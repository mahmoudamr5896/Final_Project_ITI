...
import imageSrc from './1.jpg'; // Import the image file
                ...
                <div className="row justify-content-center">
                    <div className="col-12 col-sm-10 col-md-12 col-lg-11 col-xl-10">
                        <div className="card1 d-flex mx-auto my-5">
                            <div className="row">
                                <div className="col-md-5 col-sm-12 col-xs-12 c1 p-5 bg-primary">
                                    <div className="row mb-5 m-3">
                                     {/* <img src="https://i.imgur.com/pFfTOwy.jpg" width="70vw" height="55vh" alt=""/>  */}

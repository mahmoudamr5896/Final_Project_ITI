            ...
            <div className="container">
                <div className="row g-5">
                    ...
                    <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <p><i className="far fa-check-circle Trust me-3"></i>Quality health care</p>
                        <p><i className="far fa-check-circle Trust me-3"></i>Only Qualified Doctors</p>
                        <p><i className="far fa-check-circle Trust me-3"></i>Medical Research Professionals</p>
                        <a className="btn Trust rounded-pill py-3 px-5 mt-3" href="">Read More</a>
                    </div>
                </div>
            </div>
        </div>
